...
const BLOCKS: [string, string][] = [
  ["Who we are", "Crawler Que is operated by Strat IQ Digital (\"we\", \"us\"), registered at 1/3-5 Winston St, Asquith NSW 2077, Australia. This policy explains what data we collect when you use crawlerque.com and why."],
  ...
  ["Cookies", "We use a single authentication cookie (crawlerque_session) to keep you logged in. We do not use third-party advertising cookies."],
  ["Data retention", "Reports are retained per your plan's history window. Account data is kept while your account is active; request deletion at any time at info@crawlerque.com and we will remove your account and reports within 30 days, except records we must keep for tax or legal reasons."],
  ["Your rights", "You may request a copy, correction, or deletion of your personal data at info@crawlerque.com. If you are in the EU/UK, you have rights under GDPR including complaint to a supervisory authority."],
...
export default function PrivacyPolicyPage() {
  return (
    <main className="min-h-screen bg-[var(--cq-ink)] text-[var(--cq-text)]">
      <SiteNav />
      <PageHero eyebrow="Legal" title="Privacy Policy" sub="Last updated: 2026-07-01" />
      <Section>
