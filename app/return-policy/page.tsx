...
const BLOCKS: [string, string][] = [
  ...
  ["7-day money-back guarantee", "If Crawler Que isn't right for you, email info@crawlerque.com within 7 days of your first payment and we will refund it in full — no questions, no forms. This applies to your first subscription payment only."],
