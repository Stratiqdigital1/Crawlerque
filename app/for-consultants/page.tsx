...
export default function ForConsultantsPage() {
  return (
    <PersonaPage
      ...
      sub="Deliver branded intelligence reports that justify premium rates — starting at $30/month for ten full audits."
      pains={[
      ...
      features={[
        { t: "Starter plan at $30", d: "Ten full audits per month, all eight modules, branded PDF export. Pays for itself with one report." },
